class /GDA/SDM_CL_MATERIAL definition
  public
...
CLASS /GDA/SDM_CL_MATERIAL IMPLEMENTATION.
...
* Retrieve GUIDs...
    LOOP AT mt_brf_attributes ASSIGNING <brf_attributes>.
      ...
      READ TABLE mt_function_attributes INTO ms_function_attributes WITH KEY sdm_object = 'MATERIAL'
