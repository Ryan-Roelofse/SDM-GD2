*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GDA/SDM_STP4_V
*   generation date: 02.01.2019 at 11:55:10
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GDA/SDM_STP4_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GDA/SDM_STP4_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GDA/SDM_STP4_V_EXTRACT
TOTAL = /GDA/SDM_STP4_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_STP4_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GDA/SDM_STP4_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_STP4_V_EXTRACT
TOTAL = /GDA/SDM_STP4_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GDA/SDM_STP4_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GDA/SDM_STP4_V'
...
TOTAL = /GDA/SDM_STP4_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GDA/SDM_STP4_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GDA/SDM_STP4_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_STP4_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GDA/SDM_STP4_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_STP4_V_EXTRACT
TOTAL = /GDA/SDM_STP4_V_TOTAL
