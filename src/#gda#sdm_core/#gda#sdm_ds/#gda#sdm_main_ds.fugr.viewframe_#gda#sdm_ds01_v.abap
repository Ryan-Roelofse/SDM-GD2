*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GDA/SDM_DS01_V
*   generation date: 28.08.2019 at 12:04:31 by user RROELOFSE
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GDA/SDM_DS01_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS01_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GDA/SDM_DS01_V_EXTRACT
TOTAL = /GDA/SDM_DS01_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS01_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GDA/SDM_DS01_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS01_V_EXTRACT
TOTAL = /GDA/SDM_DS01_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GDA/SDM_DS01_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS01_V'
...
TOTAL = /GDA/SDM_DS01_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GDA/SDM_DS01_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GDA/SDM_DS01_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS01_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GDA/SDM_DS01_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS01_V_EXTRACT
TOTAL = /GDA/SDM_DS01_V_TOTAL
