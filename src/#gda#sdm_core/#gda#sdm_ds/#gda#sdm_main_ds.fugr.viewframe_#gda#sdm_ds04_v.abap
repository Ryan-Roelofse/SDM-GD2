*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GDA/SDM_DS04_V
*   generation date: 28.08.2019 at 19:55:59 by user RROELOFSE
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GDA/SDM_DS04_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS04_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GDA/SDM_DS04_V_EXTRACT
TOTAL = /GDA/SDM_DS04_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS04_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GDA/SDM_DS04_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS04_V_EXTRACT
TOTAL = /GDA/SDM_DS04_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GDA/SDM_DS04_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS04_V'
...
TOTAL = /GDA/SDM_DS04_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GDA/SDM_DS04_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GDA/SDM_DS04_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS04_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GDA/SDM_DS04_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS04_V_EXTRACT
TOTAL = /GDA/SDM_DS04_V_TOTAL
