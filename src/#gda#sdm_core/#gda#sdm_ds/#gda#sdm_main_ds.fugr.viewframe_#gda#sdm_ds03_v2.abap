*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GDA/SDM_DS03_V2
*   generation date: 02.09.2019 at 11:50:27 by user RROELOFSE
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GDA/SDM_DS03_V2    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS03_V2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GDA/SDM_DS03_V2_EXTRACT
TOTAL = /GDA/SDM_DS03_V2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS03_V2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GDA/SDM_DS03_V2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS03_V2_EXTRACT
TOTAL = /GDA/SDM_DS03_V2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GDA/SDM_DS03_V2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS03_V2'
...
TOTAL = /GDA/SDM_DS03_V2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GDA/SDM_DS03_V2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GDA/SDM_DS03_V2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GDA/SDM_DS03_V2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GDA/SDM_DS03_V2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GDA/SDM_DS03_V2_EXTRACT
TOTAL = /GDA/SDM_DS03_V2_TOTAL
