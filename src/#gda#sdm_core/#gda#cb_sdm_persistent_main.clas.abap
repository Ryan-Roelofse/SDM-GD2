class /GDA/CB_SDM_PERSISTENT_MAIN definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to /GDA/CL_SDM_PERSISTENT_MAIN
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to /GDA/CL_SDM_PERSISTENT_MAIN .
  types:
    begin of TYP_BUSINESS_KEY ,
      SDM_OBJECT_ID type /GDA/SDM_DE_OBJECT_ID ,
      SDM_TABKEY type CDTABKEY ,
      TABNAME type /GDA/SDM_DE_TABNAME ,
      FIELD type /GDA/SDM_DE_FIELDNAME ,
      MSG_ID type SYMSGID ,
  ...
  types:
    begin of TYP_DB_DATA ,
      ...
      SPR_STATUS type /GDA/SDM_DE_SPRINT_STATUS ,
...
CLASS /GDA/CB_SDM_PERSISTENT_MAIN IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_SDM_OBJECT_ID TYPE /GDA/SDM_DE_OBJECT_ID
*      IMPORTING I_SDM_TABKEY TYPE CDTABKEY
*      IMPORTING I_TABNAME TYPE /GDA/SDM_DE_TABNAME
*      IMPORTING I_FIELD TYPE /GDA/SDM_DE_FIELDNAME
*      IMPORTING I_MSG_ID TYPE SYMSGID
*      IMPORTING I_MSG_NUMBER TYPE SYMSGNO
*      IMPORTING I_BEGDA TYPE DATUM
*      IMPORTING I_SDM_TYPE TYPE /GDA/SDM_DE_TYPE
*      RETURNING RESULT TYPE REF TO /GDA/CL_SDM_PERSISTENT_MAIN
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-SDM_OBJECT_ID = I_SDM_OBJECT_ID.
  BUSINESS_KEY-SDM_TABKEY = I_SDM_TABKEY.
  BUSINESS_KEY-TABNAME = I_TABNAME.
  BUSINESS_KEY-FIELD = I_FIELD.
  BUSINESS_KEY-MSG_ID = I_MSG_ID.
  BUSINESS_KEY-MSG_NUMBER = I_MSG_NUMBER.
  BUSINESS_KEY-BEGDA = I_BEGDA.
  BUSINESS_KEY-SDM_TYPE = I_SDM_TYPE.
*>
...
*<  Generated from mapping:
          THE_OBJECT->SDM_OBJECT_ID = I_SDM_OBJECT_ID.
          THE_OBJECT->SDM_TABKEY = I_SDM_TABKEY.
          THE_OBJECT->TABNAME = I_TABNAME.
          THE_OBJECT->FIELD = I_FIELD.
          THE_OBJECT->MSG_ID = I_MSG_ID.
          THE_OBJECT->MSG_NUMBER = I_MSG_NUMBER.
          THE_OBJECT->BEGDA = I_BEGDA.
          THE_OBJECT->SDM_TYPE = I_SDM_TYPE.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_SDM_OBJECT_ID = BUSINESS_KEY-SDM_OBJECT_ID
                 I_SDM_TABKEY = BUSINESS_KEY-SDM_TABKEY
                 I_TABNAME = BUSINESS_KEY-TABNAME
                 I_FIELD = BUSINESS_KEY-FIELD
                 I_MSG_ID = BUSINESS_KEY-MSG_ID
                 I_MSG_NUMBER = BUSINESS_KEY-MSG_NUMBER
                 I_BEGDA = BUSINESS_KEY-BEGDA
                 I_SDM_TYPE = BUSINESS_KEY-SDM_TYPE
...
*<Generated from mapping:
  E_BUSINESS_KEY-SDM_OBJECT_ID  = I_DB_DATA-SDM_OBJECT_ID.
  E_BUSINESS_KEY-SDM_TABKEY  = I_DB_DATA-SDM_TABKEY.
  E_BUSINESS_KEY-TABNAME  = I_DB_DATA-TABNAME.
  E_BUSINESS_KEY-FIELD  = I_DB_DATA-FIELD.
  E_BUSINESS_KEY-MSG_ID  = I_DB_DATA-MSG_ID.
  E_BUSINESS_KEY-MSG_NUMBER  = I_DB_DATA-MSG_NUMBER.
  E_BUSINESS_KEY-BEGDA  = I_DB_DATA-BEGDA.
  E_BUSINESS_KEY-SDM_TYPE  = I_DB_DATA-SDM_TYPE.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to /GDA/CL_SDM_PERSISTENT_MAIN,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-SDM_OBJECT_ID = THE_OBJECT->SDM_OBJECT_ID.
    OBJECT_DATA_ITEM-SDM_TABKEY = THE_OBJECT->SDM_TABKEY.
    OBJECT_DATA_ITEM-TABNAME = THE_OBJECT->TABNAME.
    OBJECT_DATA_ITEM-FIELD = THE_OBJECT->FIELD.
    OBJECT_DATA_ITEM-MSG_ID = THE_OBJECT->MSG_ID.
    OBJECT_DATA_ITEM-MSG_NUMBER = THE_OBJECT->MSG_NUMBER.
    OBJECT_DATA_ITEM-BEGDA = THE_OBJECT->BEGDA.
    OBJECT_DATA_ITEM-SDM_TYPE = THE_OBJECT->SDM_TYPE.
    OBJECT_DATA_ITEM-ENDDA = THE_OBJECT->ENDDA.
    OBJECT_DATA_ITEM-MSG_TYPE = THE_OBJECT->MSG_TYPE.
    OBJECT_DATA_ITEM-SPR_STATUS = THE_OBJECT->SPR_STATUS.
    OBJECT_DATA_ITEM-EXTRA_V2 = THE_OBJECT->EXTRA_V2.
    OBJECT_DATA_ITEM-EXTRA_V3 = THE_OBJECT->EXTRA_V3.
    OBJECT_DATA_ITEM-EXTRA_V4 = THE_OBJECT->EXTRA_V4.
    OBJECT_DATA_ITEM-EXTRA_V5 = THE_OBJECT->EXTRA_V5.
    OBJECT_DATA_ITEM-EXTRA_V6 = THE_OBJECT->EXTRA_V6.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO /GDA/CL_SDM_PERSISTENT_MAIN.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->SDM_OBJECT_ID,
             THE_OBJECT->SDM_TABKEY,
             THE_OBJECT->TABNAME,
             THE_OBJECT->FIELD,
             THE_OBJECT->MSG_ID,
             THE_OBJECT->MSG_NUMBER,
             THE_OBJECT->BEGDA,
             THE_OBJECT->SDM_TYPE,
             THE_OBJECT->ENDDA,
             THE_OBJECT->MSG_TYPE,
             THE_OBJECT->SPR_STATUS,
             THE_OBJECT->EXTRA_V2,
             THE_OBJECT->EXTRA_V3,
             THE_OBJECT->EXTRA_V4,
             THE_OBJECT->EXTRA_V5,
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type /GDA/SDM_EXC_MAI.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB__GDA_SDM_EXC_MAI> type /GDA/SDM_EXC_MAI.
*>

*< Generated from mapping:
  select * from /GDA/SDM_EXC_MAI
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where /GDA/SDM_EXC_MAI~SDM_OBJECT_ID =
           I_BUSINESS_KEY_TAB-SDM_OBJECT_ID
             and /GDA/SDM_EXC_MAI~SDM_TABKEY =
             I_BUSINESS_KEY_TAB-SDM_TABKEY
             and /GDA/SDM_EXC_MAI~TABNAME = I_BUSINESS_KEY_TAB-TABNAME
             and /GDA/SDM_EXC_MAI~FIELD = I_BUSINESS_KEY_TAB-FIELD
             and /GDA/SDM_EXC_MAI~MSG_ID = I_BUSINESS_KEY_TAB-MSG_ID
             and /GDA/SDM_EXC_MAI~MSG_NUMBER =
             I_BUSINESS_KEY_TAB-MSG_NUMBER
             and /GDA/SDM_EXC_MAI~BEGDA = I_BUSINESS_KEY_TAB-BEGDA
             and /GDA/SDM_EXC_MAI~SDM_TYPE =
             I_BUSINESS_KEY_TAB-SDM_TYPE.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = '/GDA/SDM_EXC_MAI'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB__GDA_SDM_EXC_MAI>.

*< Generated from mapping:
    DB_DATA-SDM_OBJECT_ID = <FS_DB__GDA_SDM_EXC_MAI>-SDM_OBJECT_ID.
    DB_DATA-SDM_TABKEY = <FS_DB__GDA_SDM_EXC_MAI>-SDM_TABKEY.
    DB_DATA-TABNAME = <FS_DB__GDA_SDM_EXC_MAI>-TABNAME.
    DB_DATA-FIELD = <FS_DB__GDA_SDM_EXC_MAI>-FIELD.
    DB_DATA-MSG_ID = <FS_DB__GDA_SDM_EXC_MAI>-MSG_ID.
    DB_DATA-MSG_NUMBER = <FS_DB__GDA_SDM_EXC_MAI>-MSG_NUMBER.
    DB_DATA-BEGDA = <FS_DB__GDA_SDM_EXC_MAI>-BEGDA.
    DB_DATA-SDM_TYPE = <FS_DB__GDA_SDM_EXC_MAI>-SDM_TYPE.
    DB_DATA-ENDDA = <FS_DB__GDA_SDM_EXC_MAI>-ENDDA.
    DB_DATA-MSG_TYPE = <FS_DB__GDA_SDM_EXC_MAI>-MSG_TYPE.
    DB_DATA-SPR_STATUS = <FS_DB__GDA_SDM_EXC_MAI>-SPR_STATUS.
    DB_DATA-EXTRA_V2 = <FS_DB__GDA_SDM_EXC_MAI>-EXTRA_V2.
    DB_DATA-EXTRA_V3 = <FS_DB__GDA_SDM_EXC_MAI>-EXTRA_V3.
    DB_DATA-EXTRA_V4 = <FS_DB__GDA_SDM_EXC_MAI>-EXTRA_V4.
    DB_DATA-EXTRA_V5 = <FS_DB__GDA_SDM_EXC_MAI>-EXTRA_V5.
    DB_DATA-EXTRA_V6 = <FS_DB__GDA_SDM_EXC_MAI>-EXTRA_V6.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-SDM_OBJECT_ID = BUSINESS_KEY-SDM_OBJECT_ID.
    <FS_OBJECT_DATA>-SDM_TABKEY = BUSINESS_KEY-SDM_TABKEY.
    <FS_OBJECT_DATA>-TABNAME = BUSINESS_KEY-TABNAME.
    <FS_OBJECT_DATA>-FIELD = BUSINESS_KEY-FIELD.
    <FS_OBJECT_DATA>-MSG_ID = BUSINESS_KEY-MSG_ID.
    <FS_OBJECT_DATA>-MSG_NUMBER = BUSINESS_KEY-MSG_NUMBER.
    <FS_OBJECT_DATA>-BEGDA = BUSINESS_KEY-BEGDA.
    <FS_OBJECT_DATA>-SDM_TYPE = BUSINESS_KEY-SDM_TYPE.
*>
...
* * /GDA/SDM_EXC_MAI: internal tables for mass operation
  data DB_ITB_/GDA/SDM_EXC_MAI type STANDARD TABLE OF /GDA/SDM_EXC_MAI.
  data DB_UTB_/GDA/SDM_EXC_MAI type STANDARD TABLE OF /GDA/SDM_EXC_MAI.
  data DB_DTB_/GDA/SDM_EXC_MAI type STANDARD TABLE OF /GDA/SDM_EXC_MAI.

* * /GDA/SDM_EXC_MAI: headlines for tables
  data DB_ILN_/GDA/SDM_EXC_MAI type /GDA/SDM_EXC_MAI.
  data DB_ULN_/GDA/SDM_EXC_MAI type /GDA/SDM_EXC_MAI.
  data DB_DLN_/GDA/SDM_EXC_MAI type /GDA/SDM_EXC_MAI.
...
*< Generated from mapping:
   ...
   DB_ILN_/GDA/SDM_EXC_MAI-ENDDA = <FS_INSERT>-ENDDA.
   DB_ILN_/GDA/SDM_EXC_MAI-MSG_TYPE = <FS_INSERT>-MSG_TYPE.
   DB_ILN_/GDA/SDM_EXC_MAI-SPR_STATUS = <FS_INSERT>-SPR_STATUS.
   DB_ILN_/GDA/SDM_EXC_MAI-EXTRA_V2 = <FS_INSERT>-EXTRA_V2.
   DB_ILN_/GDA/SDM_EXC_MAI-EXTRA_V3 = <FS_INSERT>-EXTRA_V3.
   DB_ILN_/GDA/SDM_EXC_MAI-EXTRA_V4 = <FS_INSERT>-EXTRA_V4.
   DB_ILN_/GDA/SDM_EXC_MAI-EXTRA_V5 = <FS_INSERT>-EXTRA_V5.
   DB_ILN_/GDA/SDM_EXC_MAI-EXTRA_V6 = <FS_INSERT>-EXTRA_V6.


   DB_ILN_/GDA/SDM_EXC_MAI-SDM_OBJECT_ID = <FS_INSERT>-SDM_OBJECT_ID.
   DB_ILN_/GDA/SDM_EXC_MAI-SDM_TABKEY = <FS_INSERT>-SDM_TABKEY.
   DB_ILN_/GDA/SDM_EXC_MAI-TABNAME = <FS_INSERT>-TABNAME.
   DB_ILN_/GDA/SDM_EXC_MAI-FIELD = <FS_INSERT>-FIELD.
   DB_ILN_/GDA/SDM_EXC_MAI-MSG_ID = <FS_INSERT>-MSG_ID.
   DB_ILN_/GDA/SDM_EXC_MAI-MSG_NUMBER = <FS_INSERT>-MSG_NUMBER.
   DB_ILN_/GDA/SDM_EXC_MAI-BEGDA = <FS_INSERT>-BEGDA.
   DB_ILN_/GDA/SDM_EXC_MAI-SDM_TYPE = <FS_INSERT>-SDM_TYPE.
   append DB_ILN_/GDA/SDM_EXC_MAI to DB_ITB_/GDA/SDM_EXC_MAI.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_/GDA/SDM_EXC_MAI-ENDDA = <FS_UPDATE>-ENDDA.
   DB_ULN_/GDA/SDM_EXC_MAI-MSG_TYPE = <FS_UPDATE>-MSG_TYPE.
   DB_ULN_/GDA/SDM_EXC_MAI-SPR_STATUS = <FS_UPDATE>-SPR_STATUS.
   DB_ULN_/GDA/SDM_EXC_MAI-EXTRA_V2 = <FS_UPDATE>-EXTRA_V2.
   DB_ULN_/GDA/SDM_EXC_MAI-EXTRA_V3 = <FS_UPDATE>-EXTRA_V3.
   DB_ULN_/GDA/SDM_EXC_MAI-EXTRA_V4 = <FS_UPDATE>-EXTRA_V4.
   DB_ULN_/GDA/SDM_EXC_MAI-EXTRA_V5 = <FS_UPDATE>-EXTRA_V5.
   DB_ULN_/GDA/SDM_EXC_MAI-EXTRA_V6 = <FS_UPDATE>-EXTRA_V6.


   DB_ULN_/GDA/SDM_EXC_MAI-SDM_OBJECT_ID = <FS_UPDATE>-SDM_OBJECT_ID.
   DB_ULN_/GDA/SDM_EXC_MAI-SDM_TABKEY = <FS_UPDATE>-SDM_TABKEY.
   DB_ULN_/GDA/SDM_EXC_MAI-TABNAME = <FS_UPDATE>-TABNAME.
   DB_ULN_/GDA/SDM_EXC_MAI-FIELD = <FS_UPDATE>-FIELD.
   DB_ULN_/GDA/SDM_EXC_MAI-MSG_ID = <FS_UPDATE>-MSG_ID.
   DB_ULN_/GDA/SDM_EXC_MAI-MSG_NUMBER = <FS_UPDATE>-MSG_NUMBER.
   DB_ULN_/GDA/SDM_EXC_MAI-BEGDA = <FS_UPDATE>-BEGDA.
   DB_ULN_/GDA/SDM_EXC_MAI-SDM_TYPE = <FS_UPDATE>-SDM_TYPE.
   append DB_ULN_/GDA/SDM_EXC_MAI TO DB_UTB_/GDA/SDM_EXC_MAI.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_/GDA/SDM_EXC_MAI-SDM_OBJECT_ID =
    <FS_DELETE>-BUSINESS_KEY-SDM_OBJECT_ID.
    DB_DLN_/GDA/SDM_EXC_MAI-SDM_TABKEY =
    <FS_DELETE>-BUSINESS_KEY-SDM_TABKEY.
    DB_DLN_/GDA/SDM_EXC_MAI-TABNAME = <FS_DELETE>-BUSINESS_KEY-TABNAME.
    DB_DLN_/GDA/SDM_EXC_MAI-FIELD = <FS_DELETE>-BUSINESS_KEY-FIELD.
    DB_DLN_/GDA/SDM_EXC_MAI-MSG_ID = <FS_DELETE>-BUSINESS_KEY-MSG_ID.
    DB_DLN_/GDA/SDM_EXC_MAI-MSG_NUMBER =
    <FS_DELETE>-BUSINESS_KEY-MSG_NUMBER.
    DB_DLN_/GDA/SDM_EXC_MAI-BEGDA = <FS_DELETE>-BUSINESS_KEY-BEGDA.
    DB_DLN_/GDA/SDM_EXC_MAI-SDM_TYPE =
    <FS_DELETE>-BUSINESS_KEY-SDM_TYPE.

    append DB_DLN_/GDA/SDM_EXC_MAI TO DB_DTB_/GDA/SDM_EXC_MAI.
...
* * DB Deletes
  delete /GDA/SDM_EXC_MAI FROM TABLE DB_DTB_/GDA/SDM_EXC_MAI.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = '/GDA/SDM_EXC_MAI'.
  endif.

* * DB Inserts
  insert /GDA/SDM_EXC_MAI FROM TABLE DB_ITB_/GDA/SDM_EXC_MAI
...
* * DB Updates
  update /GDA/SDM_EXC_MAI FROM TABLE DB_UTB_/GDA/SDM_EXC_MAI.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-SDM_OBJECT_ID.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-SDM_TABKEY.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-TABNAME.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-FIELD.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-MSG_ID.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-MSG_NUMBER.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-BEGDA.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-SDM_TYPE.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
*<  Generated from mapping:
  THE_OBJECT->SDM_OBJECT_ID = I_OBJECT_DATA-SDM_OBJECT_ID.
  THE_OBJECT->SDM_TABKEY = I_OBJECT_DATA-SDM_TABKEY.
  THE_OBJECT->TABNAME = I_OBJECT_DATA-TABNAME.
  THE_OBJECT->FIELD = I_OBJECT_DATA-FIELD.
  THE_OBJECT->MSG_ID = I_OBJECT_DATA-MSG_ID.
  THE_OBJECT->MSG_NUMBER = I_OBJECT_DATA-MSG_NUMBER.
  THE_OBJECT->BEGDA = I_OBJECT_DATA-BEGDA.
  THE_OBJECT->SDM_TYPE = I_OBJECT_DATA-SDM_TYPE.
  THE_OBJECT->ENDDA = I_OBJECT_DATA-ENDDA.
  THE_OBJECT->MSG_TYPE = I_OBJECT_DATA-MSG_TYPE.
  THE_OBJECT->SPR_STATUS = I_OBJECT_DATA-SPR_STATUS.
  THE_OBJECT->EXTRA_V2 = I_OBJECT_DATA-EXTRA_V2.
  THE_OBJECT->EXTRA_V3 = I_OBJECT_DATA-EXTRA_V3.
  THE_OBJECT->EXTRA_V4 = I_OBJECT_DATA-EXTRA_V4.
  THE_OBJECT->EXTRA_V5 = I_OBJECT_DATA-EXTRA_V5.
  THE_OBJECT->EXTRA_V6 = I_OBJECT_DATA-EXTRA_V6.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to /GDA/CL_SDM_PERSISTENT_MAIN.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->SDM_OBJECT_ID = I_BUSINESS_KEY-SDM_OBJECT_ID.
  NEW_OBJECT->SDM_TABKEY = I_BUSINESS_KEY-SDM_TABKEY.
  NEW_OBJECT->TABNAME = I_BUSINESS_KEY-TABNAME.
  NEW_OBJECT->FIELD = I_BUSINESS_KEY-FIELD.
  NEW_OBJECT->MSG_ID = I_BUSINESS_KEY-MSG_ID.
  NEW_OBJECT->MSG_NUMBER = I_BUSINESS_KEY-MSG_NUMBER.
  NEW_OBJECT->BEGDA = I_BUSINESS_KEY-BEGDA.
  NEW_OBJECT->SDM_TYPE = I_BUSINESS_KEY-SDM_TYPE.
* >
